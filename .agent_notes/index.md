...
changelog/2026-08-14-send-the-next-occurrence-of-a-recurring-task-to-its-own-list.md: move-recurring-to-lane + recurring-lane-name, so ticking a recurring card sends the occurrence Tasks schedules to its own list instead of leaving it in the completed card's place.
